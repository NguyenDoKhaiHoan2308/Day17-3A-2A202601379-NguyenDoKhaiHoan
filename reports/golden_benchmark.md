...
- Average retrieval latency: **990.7 ms**
...
| G08 | long_term | PASS | 1448.4 | 817 | 0.0% |  |
| G09 | long_term | PASS | 1510.6 | 1426 | 0.0% |  |
| G12 | semantic | PASS | 292.4 | 365 | 20.5% |  |
| G14 | semantic | PASS | 245.6 | 217 | 43.9% |  |
| G15 | semantic | PASS | 267.8 | 217 | 52.7% |  |
| G19 | mixed | PASS | 1614.2 | 581 | 0.0% |  |
| G03 | long_term | PASS | 1478.6 | 1376 | 0.0% |  |
| G04 | long_term | PASS | 1398.9 | 1385 | 0.0% |  |
| G05 | long_term | PASS | 1324.7 | 1371 | 0.0% |  |
| G10 | episodic | PASS | 251.5 | 454 | 0.0% |  |
| G11 | episodic | PASS | 466.4 | 454 | 0.0% |  |
| G13 | semantic | PASS | 273.3 | 363 | 35.8% |  |
| G16 | mixed | PASS | 1902.8 | 581 | 0.0% |  |
| G18 | mixed | PASS | 544.4 | 489 | 13.5% |  |
| G20 | mixed | PASS | 1894.7 | 831 | 0.0% |  |
| G06 | long_term | PASS | 1533.2 | 1383 | 0.0% |  |
| G07 | long_term | PASS | 1745.3 | 1371 | 0.0% |  |
| G17 | mixed | PASS | 1620.3 | 581 | 8.1% |  |
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this project. The user is debugging async HTTP for ORCHID-27, finding that increasing the timeout was ineffective. The primary issue identified is connection churn, and an effective approach involves reusing the aiohttp ClientSession with a concurrency of 20. The user is interested in connection pool, client lifecycle, and concurrency.  Minh Nguyen prefers Python and dislikes Java. When explaining code, Minh prefers concise examples. The user is currently studying async/await and often c`
...
`<USER_SUMMARY> The user is working on two projects: ORCHID-27, for which they prefer Python, and BLUEBIRD-42, which requires TypeScript with NestJS and explicitly forbids Python. The user is debugging async HTTP for ORCHID-27 and is interested in connection pooling, client lifecycle, and concurrency. An effective approach involves reusing the aiohttp ClientSession with a concurrency of 20.  Minh Nguyen prefers Python and dislikes Java. When explaining code, Minh prefers concise examples. The user is currently studying async/await and often confuses coroutines with Tasks. If this topic arises in the future, the user wants explanations provided as a timeline.  The AI will prioritize using a ti`
...
`EPISODE: Do not persist personal data without explicit opt-in. A deletion request must remove user-scoped memory and be verified across every store. Marker: DELETE-VERIFY-ALL. metadata= EPISODE: {"id":"kb-async-http","entity":"Async HTTP Incident Playbook","summary":"When async HTTP calls time out, inspect connection pooling, downstream saturation and concurrency before increasing timeout. Reuse a long-lived client session where possible. Marker: CONN-POOL-FIRST.","source":"incident-playbook-2026","updated_at":"2026-08-11T00:00:00Z"} metadata= EPISODE: When async HTTP calls time out, inspect connection pooling, downstream saturation and concurrency before increasing timeout. Reuse a long-liv`

### G16 - mixed

`<LONG_TERM> <USER_SUMMARY> The user is working on two projects: ORCHID-27, for which they prefer Python, and BLUEBIRD-42, which requires TypeScript with NestJS and explicitly forbids Python. The user is debugging async HTTP for ORCHID-27 and is interested in connection pooling, client lifecycle, and concurrency. An effective approach involves reusing the aiohttp ClientSession with a concurrency of 20.  Minh Nguyen prefers Python and dislikes Java. When explaining code, Minh prefers concise examples. The user is currently studying async/await and often confuses coroutines with Tasks. If this topic arises in the future, the user wants explanations provided as a timeline.  The AI will prioritiz`
